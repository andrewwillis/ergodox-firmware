...
// left hand
   ...
   _shiftL,     _Z,         _X,      _C,      _V,    _B,    1,
    _ctrlL, _grave, _backslash,  _equal,   _guiL,
                                                 _altL, _ctrlL,
                                              0,      0, _home,
                                            _bs,  _guiL,  _end,
// right hand
...
// {{{2
	KB_MATRIX_LAYER(  // layout: layer 4: arrow keys
// unused
0,
// left hand
  0,     0,  0,  0,  0,  0,  0,
...
// left hand
 ...
 lpush4, kprrel, kprrel, kprrel, kprrel, kprrel,
...
// left hand
 ...
 ktrans, ktrans, ktrans, ktrans, kprrel,
                                                 ktrans, ktrans,
...
// {{{2
	KB_MATRIX_LAYER(  // press: layer 4: arrow keys
// unused
NULL,
// left hand
 ...
 ktrans, ktrans, ktrans, ktrans, ktrans, ktrans, ktrans,
 ktrans, ktrans, ktrans, ktrans, ktrans, ktrans, ktrans,
 lpush4, kprrel, ktrans, ktrans, ktrans, ktrans,
 ktrans, ktrans, ktrans, ktrans, ktrans, ktrans, ktrans,
 ktrans, ktrans, ktrans, ktrans, ktrans,
                                                 ktrans, ktrans,
                                         ktrans, ktrans, ktrans,
...
// right hand
        ktrans, ktrans, ktrans, ktrans, ktrans, ktrans, ktrans,
        ktrans, ktrans, kprrel, ktrans, ktrans, ktrans, ktrans,
...
// left hand
 ...
 kprrel, kprrel, kprrel, kprrel, kprrel, kprrel,   NULL,
  lpop4, kprrel, kprrel, kprrel, kprrel, kprrel,
...
// {{{2
	KB_MATRIX_LAYER(  // release: layer 4: arrow keys
// unused
NULL,
// left hand
   NULL, kprrel, kprrel, kprrel, kprrel, kprrel, kprrel,
 ktrans,sshprre,sshprre, kprrel, kprrel,   NULL,   NULL,
 lpop4, kprrel, kprrel, kprrel, kprrel,sshprre,
 ktrans, kprrel, kprrel, kprrel, kprrel,sshprre,  lpop2,
 ktrans, ktrans, ktrans, ktrans, ktrans,
                                                 ktrans, ktrans,
                                         ktrans, ktrans, ktrans,
